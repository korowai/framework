...
.. literalinclude:: ../../examples/basiclib/trivial_singleton.php
  :linenos:
  :start-after: [use]
  :end-before: [/use]
...
.. literalinclude:: ../../examples/basiclib/count_singleton.php
   :linenos:
   :caption: Usage of Singleton
   :name: lib.singleton.count_singleton.example

.. literalinclude:: ../../examples/basiclib/count_singleton.stdout
  :linenos:
  :language: none
