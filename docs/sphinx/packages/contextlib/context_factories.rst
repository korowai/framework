...
.. _contextlib.context-factories:

Context Factories
=================

:ref:`contextlib` has a concept of *Context Factory* (a precise name
...
:ref:`contextlib` has a single stack of (custom) *Context Factories*
...
.. literalinclude:: ../../examples/contextlib/my_context_factory.php
   :linenos:
   :start-after: [use]
   :end-before: [/use]
...
.. literalinclude:: ../../examples/contextlib/my_context_factory.stdout
   :linenos:
   :language: none
