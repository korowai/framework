...
.. _contextlib.exception-handling:
...
:ref:`contextlib.multiple-context-arguments`. We'll use same ``MyInt`` objects as context
managers for all context arguments

.. literalinclude:: ../../examples/contextlib/exception_handling.php
   :linenos:
   :start-after: [MyInt]
   :end-before: [/MyInt]
...
- stdout:
   ...
   .. literalinclude:: ../../examples/contextlib/exception_handling.stdout
      :linenos:
      :language: none

- stderr:

   .. literalinclude:: ../../examples/contextlib/exception_handling.stderr
      :linenos:
      :language: none
...
.. literalinclude:: ../../examples/contextlib/exit_true.php
   :linenos:
   :start-after: [MyInt]
   :end-before: [/MyInt]
...
.. literalinclude:: ../../examples/contextlib/exit_true.stdout
   :linenos:
   :language: none
