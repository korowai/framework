...
.. _errorlib.caller-error-handlers:

Caller Error Handlers
=====================

:ref:`errorlib.caller-error-handlers` are useful when a function implementer wants to
...
:ref:`errorlib.caller-error-handlers`, where the developer can easily point to current
...
.. literalinclude:: ../../examples/errorlib/caller_error_handler.php
   :linenos:
   :start-after: [use]
   :end-before: [/use]
...
.. literalinclude:: ../../examples/errorlib/caller_error_handler.stdout
   :linenos:
   :language: none
...
.. literalinclude:: ../../examples/errorlib/caller_error_thrower.php
   :linenos:
   :start-after: [use]
   :end-before: [/use]
...
.. literalinclude:: ../../examples/errorlib/caller_error_thrower.stdout
   :linenos:
   :language: none
