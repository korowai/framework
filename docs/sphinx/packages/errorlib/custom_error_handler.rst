...
With :ref:`errorlib` and :ref:`Contexts <contextlib>` you can
...
.. literalinclude:: ../../examples/errorlib/custom_error_handler.php
   :linenos:
   :start-after: [use]
   :end-before: [/use]
...
.. literalinclude:: ../../examples/errorlib/custom_error_handler.stdout
   :linenos:
   :language: none

- stderr:

.. literalinclude:: ../../examples/errorlib/custom_error_handler.stderr
   :linenos:
   :language: none
