...
our :ref:`Context Library <contextlib>`, so one can temporarily redirect
PHP errors to custom handlers in one location without altering other parts of
code.

:ref:`TheKorowaiFramework` uses :ref:`errorlib` to implement variants of
...
.. literalinclude:: ../../examples/errorlib/basic_example.php
   :linenos:
   :start-after: [use]
   :end-before: [/use]
