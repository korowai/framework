...
:ref:`ldaplib` uses *adapters* to interact with the actual LDAP
...
allows for different LDAP implementations to be used by :ref:`ldaplib`
in a pluggable manner. :ref:`ldaplib` itself provides an adapter named
...
.. literalinclude:: ../../examples/ldaplib/adapter_factory_1.php
   :linenos:
   :start-after: [code]
   :end-before: [/code]
...
.. literalinclude:: ../../examples/ldaplib/adapter_factory_2.php
   :linenos:
   :start-after: [code]
   :end-before: [/code]
