...
Unit-testing applications that use :ref:`ldaplib` can be troublesome.
The code under test may depend on :ref:`ldap library's <ldaplib>`
...
objects/interfaces of :ref:`ldaplib` becomes complicated when it comes
...
.. literalinclude:: ../../examples/ldaplib/mock_searchquery.php
   :linenos:
...
To facilitate unit-testing and mocking, :ref:`ldaplib` provides a bunch
...
.. _ldaplib.mocking.predefinedfakeobjects:
