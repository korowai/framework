...
:ref:`entry-level patterns<rfclib.rfc2849.entry-level-rules>` provided by the
:class:`Korowai\\Lib\\Rfc\\Rfc2849` class.


.. _rfclib.rfc2849.syntax:
...
.. _rfclib.rfc2849.top-level-rules:
...
.. seealso::
  ...
  :ref:`rfclib.rfc2849.ldif-content` |o|
  :ref:`rfclib.rfc2849.ldif-changes` |o|
  :ref:`rfclib.rfc2849.version-spec` |o|
  :ref:`rfclib.rfc2849.sep` |o|
  :ref:`rfclib.rfc2849.ldif-attrval-record` |o|
  :ref:`rfclib.rfc2849.ldif-change-record` |o|
  :ref:`rfclib.rfc2849.dn-spec` |o|
  :ref:`rfclib.rfc2849.attrval-spec` |o|
  :ref:`rfclib.rfc2849.control` |o|
  :ref:`rfclib.rfc2849.changerecord`

------------------------------------------------------------------------------

.. _rfclib.rfc2849.ldif-file:
...
.. seealso::
   ...
   :ref:`rfclib.rfc2849.ldif-content` |o|
   :ref:`rfclib.rfc2849.ldif-changes`

------------------------------------------------------------------------------

.. _rfclib.rfc2849.ldif-content:
...
.. seealso::
   ...
   :ref:`rfclib.rfc2849.version-spec` |o|
   :ref:`rfclib.rfc2849.sep` |o|
   :ref:`rfclib.rfc2849.ldif-attrval-record`

------------------------------------------------------------------------------

.. _rfclib.rfc2849.ldif-changes:
...
.. seealso::
   ...
   :ref:`rfclib.rfc2849.version-spec` |o|
   :ref:`rfclib.rfc2849.sep` |o|
   :ref:`rfclib.rfc2849.ldif-change-record`

------------------------------------------------------------------------------

.. _rfclib.rfc2849.ldif-attrval-record:

ldif-attrval-record
"""""""""""""""""""

The rule specifies syntax of single record of the
:ref:`rfclib.rfc2849.ldif-content` file.
...
.. seealso::
   ...
   :ref:`rfclib.rfc2849.dn-spec` |o|
   :ref:`rfclib.rfc2849.sep` |o|
   :ref:`rfclib.rfc2849.attrval-spec`

------------------------------------------------------------------------------

.. _rfclib.rfc2849.ldif-change-record:

ldif-change-record
""""""""""""""""""

The rule specifies syntax of single record of the
:ref:`rfclib.rfc2849.ldif-changes` file.
...
matched with the :ref:`rfclib.rfc2849.changerecord-init` rule defined later:
...
.. seealso::
   ...
   :ref:`rfclib.rfc2849.fill` |o|
   :ref:`rfclib.rfc2849.change-add` |o|
   :ref:`rfclib.rfc2849.change-delete` |o|
   :ref:`rfclib.rfc2849.change-modify` |o|
   :ref:`rfclib.rfc2849.change-moddn` |o|
   :ref:`rfclib.rfc2849.changerecord-init` |o|
   :ref:`rfclib.rfc2849.sep`

------------------------------------------------------------------------------

.. _rfclib.rfc2849.change-add:
...
.. seealso::
   ...
   :ref:`rfclib.rfc2849.sep` |o|
   :ref:`rfclib.rfc2849.mod-spec`

------------------------------------------------------------------------------

.. _rfclib.rfc2849.change-moddn:
...
.. seealso::
   ...
   :ref:`rfclib.rfc2849.sep` |o|
   :ref:`rfclib.rfc2849.fill` |o|
   :ref:`rfclib.rfc2849.rdn` |o|
   :ref:`rfclib.rfc2849.base64-rdn` |o|
   :ref:`rfclib.rfc2849.distinguishedName` |o|
   :ref:`rfclib.rfc2849.base64-distinguishedName` |o|
   :ref:`rfclib.rfc2849.newrdn-spec` |o|
   :ref:`rfclib.rfc2849.newsuperior-spec` |o|
   :ref:`rfclib.rfc2849.dn-value-spec`

------------------------------------------------------------------------------

.. _rfclib.rfc2849.mod-spec:
...
matched with custom rule :ref:`rfclib.rfc2849.mod-spec-init` defined later as
...
.. seealso::
   ...
   :ref:`rfclib.rfc2849.sep` |o|
   :ref:`rfclib.rfc2849.mod-spec-init`

------------------------------------------------------------------------------


.. _rfclib.rfc2849.entry-level-rules:
...
these patterns (plus the :ref:`rfclib.rfc2849.sep` pattern).

.. _rfclib.rfc2849.version-spec:
...
and spans to the nearest :ref:`rfclib.rfc2849.eol` (exclusive).
...
.. list-table:: VERSION_SPEC: capture groups
   ...
   * - ``version_number``
     - The whole substring between ``"version:"`` and nearest
       :ref:`rfclib.rfc2849.eol`, when the whole substring matches
       :ref:`version-number <rfclib.rfc2849.version-number>` rule.
   * - ``version_error``
     - The erroneous part of the substring between ``"version:"`` and nearest
       :ref:`rfclib.rfc2849.eol` (the part that fails to match
       :ref:`rfclib.rfc2849.version-number` rule), when the whole substring
       fails to match the :ref:`rfclib.rfc2849.version-number`.

**Example**:

.. literalinclude:: ../../examples/rfclib/rfc2849/version_spec.php
   :linenos:
   :start-after: [code]
   :end-before: [/code]
   :caption: Rfc2849::VERSION_SPEC
   :name: rfclib.rfc2849.version-spec.example

.. literalinclude:: ../../examples/rfclib/rfc2849/version_spec.stdout
   :linenos:
   :language: none
...
.. seealso::
   ...
   :ref:`rfclib.rfc2849.fill` |o|
   :ref:`rfclib.rfc2849.version-number` |o|
   :ref:`rfclib.rfc2849.eol` |o|
   :ref:`rfclib.rfc2849.noteol`

------------------------------------------------------------------------------

.. _rfclib.rfc2849.dn-spec:
...
.. list-table:: DN_SPEC: capture groups
   ...
   * - ``value_safe``
     - Substring containing the DN value. It's the whole substring between
       ``"dn:"`` and nearest :ref:`rfclib.rfc2849.eol`, if the whole substring
       is a :ref:`rfclib.rfc2849.safe-string`.
   * - ``value_b64``
     - Substring containing the DN value. It's the whole substring between
       ``"dn::"`` and nearest :ref:`rfclib.rfc2849.eol`, if the whole
       substring is a :ref:`rfclib.rfc2849.base64-string`.
   * - ``value_safe_error``
     - The erroneus part of whole substring between ``"dn:"`` and the nearest
       :ref:`rfclib.rfc2849.eol`, if the value was declared
       :ref:`rfclib.rfc2849.value-safe`, but the substring failed to match
       :ref:`rfclib.rfc2849.safe-string`.
   * - ``value_b64_error``
     - The erroneus part of whole substring between ``"dn::"`` and the nearest
       :ref:`rfclib.rfc2849.eol`, if the value was declared
       :ref:`rfclib.rfc2849.value-base64`, but the substring failed to match
       :ref:`rfclib.rfc2849.base64-string`.

**Example**:

.. literalinclude:: ../../examples/rfclib/rfc2849/dn_spec.php
   :linenos:
   :start-after: [code]
   :end-before: [/code]
   :caption: Rfc2849::DN_SPEC
   :name: rfclib.rfc2849.dn-spec.example

.. literalinclude:: ../../examples/rfclib/rfc2849/dn_spec.stdout
   :linenos:
   :language: none
...
.. seealso::
   ...
   :ref:`rfclib.rfc2849.distinguishedname` |o|
   :ref:`rfclib.rfc2849.base64-distinguishedname` |o|
   :ref:`rfclib.rfc2849.dn-value-spec` |o|
   :ref:`rfclib.rfc2849.value-safe` |o|
   :ref:`rfclib.rfc2849.value-base64` |o|
   :ref:`rfclib.rfc2849.safe-string` |o|
   :ref:`rfclib.rfc2849.base64-string` |o|
   :ref:`rfclib.rfc2849.base64-utf8-string`

------------------------------------------------------------------------------

.. _rfclib.rfc2849.control:
...
ends with :ref:`rfclib.rfc2849.eol` (inclusive).
...
.. list-table:: CONTROL: capture groups
   ...
   * - ``ctl_crit``
     - Only set, if the matched substring has no errors and defines criticality
       ...
       ``"true"`` or ``"false"``).
   * - ``value_safe``
     - Inherited from :ref:`rfclib.rfc2849.value-spec`.
   * - ``value_b64``
     - Inherited from :ref:`rfclib.rfc2849.value-spec`.
   * - ``value_url``
     - Inherited from :ref:`rfclib.rfc2849.value-spec`.
...
.. literalinclude:: ../../examples/rfclib/rfc2849/control.php
   :linenos:
   :start-after: [code]
   :end-before: [/code]
   :caption: Rfc2849::CONTROL
   :name: rfclib.rfc2849.control.example

.. literalinclude:: ../../examples/rfclib/rfc2849/control.stdout
   :linenos:
   :language: none
...
.. seealso::
    ...
    :ref:`rfclib.rfc2849.fill` |o|
    :ref:`rfclib.rfc2849.ldap-oid` |o|
    :ref:`rfclib.rfc2849.space` |o|
    :ref:`rfclib.rfc2849.value-spec` |o|
    :ref:`rfclib.rfc2849.sep` |o|
    :ref:`rfclib.rfc2849.eol` |o|
    :ref:`rfclib.rfc2849.noteol`
...
:ref:`rfclib.rfc2849.attributedescription` and ends with
:ref:`rfclib.rfc2849.eol` (inclusive).
...
:ref:`rfclib.rfc2849.url`.

**Example**:

.. literalinclude:: ../../examples/rfclib/rfc2849/attrval_spec.php
   :linenos:
   :start-after: [code]
   :end-before: [/code]
   :caption: Rfc2849::ATTRVAL_SPEC
   :name: rfclib.rfc2849.attrval-spec.example

.. literalinclude:: ../../examples/rfclib/rfc2849/attrval_spec.stdout
   :linenos:
   :language: none

.. seealso::

    :ref:`rfclib.rfc2849.attributedescription` |o|
    :ref:`rfclib.rfc2849.value-spec` |o|
    :ref:`rfclib.rfc2849.sep` |o|
    :ref:`rfclib.rfc2849.eol` |o|
    :ref:`rfclib.rfc2849.noteol`
...
.. _rfclib.rfc2849.changerecord-init:
...
``"changetype:"`` and ends with :ref:`rfclib.rfc2849.eol` (inclusive).
...
.. list-table:: CHANGERECORD_INIT: capture groups
   ...
   * - ``chg_type``
     - The whole substring between ``"changetype:"`` and the nearest
       :ref:`rfclib.rfc2849.eol`, if the substring matches one of the
       ``"add"``, ``"delete"``, ``"modify"``, ``"moddn"``, or ``"modrdn"``.
   * - ``chg_type_error``
     - The whole substring between ``"changetype:"`` and the nearest
       :ref:`rfclib.rfc2849.eol`, if the substring does not match any of the
       ``"add"``, ``"delete"``, ``"modify"``, ``"moddn"``, nor ``"modrdn"``.

**Example**:

.. literalinclude:: ../../examples/rfclib/rfc2849/changerecord_init.php
   :linenos:
   :start-after: [code]
   :end-before: [/code]
   :caption: Rfc2849::CHANGERECORD_INIT
   :name: rfclib.rfc2849.changerecord-init.example

.. literalinclude:: ../../examples/rfclib/rfc2849/changerecord_init.stdout
   :linenos:
   :language: none
...
.. list-table:: CHANGERECORD_INIT: capture groups
   ...
   * - ``attr_desc``
     - Only set if the whole substring between the initial keyword and
       the nearest :ref:`rfclib.rfc2849.eol` matches the
       :ref:`rfclib.rfc2849.attributedescription` rule. Contains the attribute
       description (attribute type and options).
   * - ``attr_type_error``
     - Only set if there is an error in the substring between the initial
       keyword and the nearest :ref:`rfclib.rfc2849.eol` (error in the
       specification of :ref:`rfclib.rfc2849.attributetype`) . Contains the
       erroneous part of the substring.
   * - ``attr_opts_error``
     - Only set if there is an error in the substring between the initial
       keyword and the nearest :ref:`rfclib.rfc2849.eol` (error in the
       specification of :ref:`rfclib.rfc2849.options`). Contains the erroneous
       part of the substring.

**Example**:

.. literalinclude:: ../../examples/rfclib/rfc2849/mod_spec_init.php
   :linenos:
   :start-after: [code]
   :end-before: [/code]
   :caption: Rfc2849::MOD_SPEC_INIT
   :name: rfclib.rfc2849.mod-spec-init.example

.. literalinclude:: ../../examples/rfclib/rfc2849/mod_spec_init.stdout
   :linenos:
   :language: none
...
.. seealso::
    ...
    :ref:`rfclib.rfc2849.fill` |o|
    :ref:`rfclib.rfc2849.attributedescription` |o|
    :ref:`rfclib.rfc2849.attributetype` |o|
    :ref:`rfclib.rfc2849.options` |o|
    :ref:`rfclib.rfc2849.sep` |o|
    :ref:`rfclib.rfc2849.eol` |o|
    :ref:`rfclib.rfc2849.noteol`
...
``"newrdn:"`` and ends with :ref:`rfclib.rfc2849.eol` (inclusive).
...
.. list-table:: NEWRDN_SPEC: capture groups
   ...
   * - ``value_safe``
     - Substring containing the RDN value. It's the whole substring between
       ``"newrdn:"`` and nearest :ref:`rfclib.rfc2849.eol`, if the whole
       substring is a :ref:`rfclib.rfc2849.safe-string`.
   * - ``value_b64``
     - Substring containing the RDN value. It's the whole substring between
       ``"newrdn::"`` and nearest :ref:`rfclib.rfc2849.eol`, if the whole
       substring is a :ref:`rfclib.rfc2849.base64-string`.
   * - ``value_safe_error``
     - The erroneus part of whole substring between ``"newrdn:"`` and the
       nearest :ref:`rfclib.rfc2849.eol`, if the value was declared
       :ref:`rfclib.rfc2849.value-safe`, but the substring failed to match
       :ref:`rfclib.rfc2849.safe-string`.
   * - ``value_b64_error``
     - The erroneus part of whole substring between ``"newrdn::"`` and the
...
.. literalinclude:: ../../examples/rfclib/rfc2849/newrdn_spec.php
   :linenos:
   :start-after: [code]
   :end-before: [/code]
   :caption: Rfc2849::NEWRDN_SPEC
   :name: rfclib.rfc2849.newrdn-spec.example

.. literalinclude:: ../../examples/rfclib/rfc2849/newrdn_spec.stdout
   :linenos:
   :language: none
...
.. seealso::
    ...
    :ref:`rfclib.rfc2849.fill` |o|
    :ref:`rfclib.rfc2849.sep` |o|
    :ref:`rfclib.rfc2849.eol`

-----------------------------------------------------------------------------

.. _rfclib.rfc2849.newsuperior-spec:
...
``"newsuperior:"`` and ends with :ref:`rfclib.rfc2849.eol` (inclusive).
...
.. list-table:: NEWSUPERIOR_SPEC: capture groups
   ...
   * - ``value_safe``
     - Substring containing the DN value. It's the whole substring between
       ``"newsuperior:"`` and nearest :ref:`rfclib.rfc2849.eol`, if the whole
       substring is a :ref:`rfclib.rfc2849.safe-string`.
   * - ``value_b64``
     - Substring containing the DN value. It's the whole substring between
       ``"newsuperior::"`` and nearest :ref:`rfclib.rfc2849.eol`, if the whole
...
.. literalinclude:: ../../examples/rfclib/rfc2849/newsuperior_spec.php
   :linenos:
   :start-after: [code]
   :end-before: [/code]
   :caption: Rfc2849::NEWSUPERIOR_SPEC
   :name: rfclib.rfc2849.newsuperior-spec.example

.. literalinclude:: ../../examples/rfclib/rfc2849/newsuperior_spec.stdout
   :linenos:
   :language: none
...
.. _rfclib.rfc2849.lower-level-rules:

Lower-level rules
-----------------

These rules are use to construct the :ref:`rfclib.rfc2849.entry-level-rules`.
They don't have to be referred directly by a higher-level parser.

.. _rfclib.rfc2849.dn-value-spec:
...
.. seealso::
    ...
    :ref:`rfclib.rfc2849.value-safe` |o|
    :ref:`rfclib.rfc2849.value-base64`


------------------------------------------------------------------------------

.. _rfclib.rfc2849.value-spec:
...
``":"`` and ends with :ref:`rfclib.rfc2849.eol` (exclusive).
...
.. list-table:: VALUE_SPEC: capture groups
   ...
   * - ``value_safe``
     - Only set if the matched string specifies
       :ref:`rfclib.rfc2849.value-safe` using single colon ``":"`` notation
       and there is no error in the substring between the initial ``":"`` and
       the nearest :ref:`rfclib.rfc2849.eol` (the whole substring matches
       :ref:`rfclib.rfc2849.safe-string` rule). Contains the whole substring.
   * - ``value_b64``
     - Only set if the matched string specifies
       :ref:`rfclib.rfc2849.value-base64` using double colon ``"::"`` notation
       and there is no error in the substring between the initial ``"::"`` and
       the nearest :ref:`rfclib.rfc2849.eol` (the whole substring matches
       :ref:`rfclib.rfc2849.base64-string` rule). Contains the whole substring.
   * - ``value_url``
     - Only set if the matched string specifies :ref:`rfclib.rfc2849.url`
       using colon-less-than ``":<"`` notation and there is no error in the
       substring between the initial ``":<"`` and the nearest
       :ref:`rfclib.rfc2849.eol` (the whole substring matches
       :ref:`rfclib.rfc2849.url` rule). Contains the whole substring.
   * - ``value_safe_error``
     - Only set if there is an error after the initial ``":"`` (single colon).
       Contains the part of substring between the initial ``":"`` and the
       nearest :ref:`rfclib.rfc2849.eol` that failed to match the
       :ref:`rfclib.rfc2849.safe-string`.
   * - ``value_b64_error``
     - Only set if there is an error after the initial ``"::"`` (double colon).
       Contains the part of substring between the initial ``"::"`` and the
       nearest :ref:`rfclib.rfc2849.eol` which failed to match the
       :ref:`rfclib.rfc2849.base64-string`.
   * - ``value_url_error``
...
.. literalinclude:: ../../examples/rfclib/rfc2849/value_spec.php
   :linenos:
   :start-after: [code]
   :end-before: [/code]
   :caption: Rfc2849::VALUE_SPEC
   :name: rfclib.rfc2849.value-spec.example

.. literalinclude:: ../../examples/rfclib/rfc2849/value_spec.stdout
   :linenos:
   :language: none
...
.. seealso::
    ...
    :ref:`rfclib.rfc2849.value-safe` |o|
    :ref:`rfclib.rfc2849.value-base64` |o|
    :ref:`rfclib.rfc2849.value-url` |o|
    :ref:`rfclib.rfc2849.safe-string` |o|
    :ref:`rfclib.rfc2849.base64-string` |o|
    :ref:`rfclib.rfc2849.url` |o|
    :ref:`rfclib.rfc2849.eol`

------------------------------------------------------------------------------

.. _rfclib.rfc2849.value-safe:
...
character other than ``":"``/``"<"`` and ends with :ref:`rfclib.rfc2849.eol`
(exclusive).
...
.. list-table:: VALUE_SAFE: capture groups
   ...
   * - ``value_safe``
     - Only set if the there is no error in the substring between the initial
       before the nearest :ref:`rfclib.rfc2849.eol` (the whole substring
       matches :ref:`rfclib.rfc2849.safe-string` rule). Contains the whole
       substring.
   * - ``value_safe_error``
     - Only set if there is an error before the nearest
       :ref:`rfclib.rfc2849.eol`. Contains the part of substring that failed
       to match the :ref:`rfclib.rfc2849.safe-string`.
...
ends with :ref:`rfclib.rfc2849.eol` (exclusive).
...
.. list-table:: VALUE_BASE64: capture groups
   ...
   * - ``value_b64``
     - Only set if there is no error in the substring between the initial
       ``":"`` and the nearest :ref:`rfclib.rfc2849.eol` (the whole substring
       matches :ref:`rfclib.rfc2849.base64-string` rule). Contains the whole
       substring.
   * - ``value_b64_error``
...
.. list-table:: VALUE_URL: capture groups
   ...
   * - ``value_url``
     - Only set if there is no error in the substring between the initial
       ``"<"`` and the nearest :ref:`rfclib.rfc2849.eol` (the whole substring
       matches :ref:`rfclib.rfc2849.url` rule). Contains the whole substring.
   * - ``value_url_error``
...
.. seealso::
   ...
   :ref:`rfclib.rfc3986` class

------------------------------------------------------------------------------

.. _rfclib.rfc2849.ldap-oid:
...
.. seealso::
   ...
   :ref:`rfclib.rfc2253` class

------------------------------------------------------------------------------

.. _rfclib.rfc2849.attributedescription:
...
.. seealso::
    ...
    RFC2251_ |o|
    :ref:`rfclib.rfc2849.attributetype` |o|
    :ref:`rfclib.rfc2849.options`

------------------------------------------------------------------------------

.. _rfclib.rfc2849.attributetype:
...
.. seealso::
    ...
    :ref:`rfclib.rfc2849.ldap-oid` |o|
    :ref:`rfclib.rfc2849.alpha` |o|
    :ref:`rfclib.rfc2849.attr-type-chars`

------------------------------------------------------------------------------

.. _rfclib.rfc2849.options:
...
.. seealso::
    ...
    :ref:`rfclib.rfc2849.option`

------------------------------------------------------------------------------

.. _rfclib.rfc2849.option:
...
.. seealso::
    ...
    :ref:`rfclib.rfc2849.opt-char`

.. _rfclib.rfc2849.version-number:
...
.. seealso::
   ...
   :ref:`rfclib.rfc2849.digit`

------------------------------------------------------------------------------

.. _rfclib.rfc2849.distinguishedname:
...
.. _rfclib.rfc2849.base64-distinguishedname:
...
.. seealso::
   ...
   :ref:`rfclib.rfc2849.cr` |o|
   :ref:`rfclib.rfc2849.lf`
...
The difference between ``EOL`` and :ref:`rfclib.rfc2849.sep` is, that ``EOL``
matches also end of string (end of last line, not ended with (CR LF/LF)),
whereas :ref:`rfclib.rfc2849.sep` matches only real line-feed characters.
...
.. _rfclib.rfc2849.noteol:

NOTEOL
""""""

``NOTEOL`` is an inverse of :ref:`rfclib.rfc2849.eol`. It matches any real
character except :ref:`rfclib.rfc2849.lf` and :ref:`rfclib.rfc2849.cr`
when followed by :ref:`rfclib.rfc2849.lf`.
...
.. seealso::
   ...
   :ref:`rfclib.rfc2849.space`

------------------------------------------------------------------------------

.. _rfclib.rfc2849.safe-string:
...
.. seealso::
   ...
   :ref:`rfclib.rfc2849.safe-init-char` |o|
   :ref:`rfclib.rfc2849.safe-char`

------------------------------------------------------------------------------

.. _rfclib.rfc2849.base64-utf8-string:
...
.. seealso::
   ...
   :ref:`rfclib.rfc2849.base64-char`

------------------------------------------------------------------------------

.. _rfclib.rfc2849.chars:

Character classes
-----------------

.. _rfclib.rfc2849.alpha:
...
.. _rfclib.rfc2849.attr-type-chars:
...
.. _rfclib.rfc2849.safe-init-char:
