<?php
/**
 * @file src/Korowai/Lib/Ldif/Rules/NewRdnRuleInterface.php
 *
...
use Korowai\Lib\Ldif\Nodes\NewRdnInterface;
 ...
 * @author Paweł Tomulik <ptomulik@meil.pw.edu.pl>
 */
interface NewRdnRuleInterface extends RuleInterface
{
    /**
