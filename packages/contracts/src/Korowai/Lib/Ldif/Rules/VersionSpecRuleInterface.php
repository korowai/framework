<?php
/**
 * @file src/Korowai/Lib/Ldif/Rules/VersionSpecRuleInterface.php
 *
 ...
 * @author Paweł Tomulik <ptomulik@meil.pw.edu.pl>
 */
interface VersionSpecRuleInterface extends RuleInterface
{
    /**
     ...
     * @param  VersionSpecInterface $value
    ...
    public function parse(
        ...
        VersionSpecInterface &$value = null,
        bool $trying = false
    ) : bool;
}
