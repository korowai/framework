<?php
/**
 * @file tests/Rules/ChangeModifyRuleTest.php
 *
...
use Korowai\Lib\Ldif\Rules\ChangeModifyRule;
 ...
 * @author Paweł Tomulik <ptomulik@meil.pw.edu.pl>
 */
class ChangeModifyRuleTest extends TestCase
{
    public function test__implementsRuleInterface()
    {
        $this->assertImplementsInterface(RuleInterface::class, ChangeModifyRule::class);
    }
    ...
    public static function construct__cases()
    {
        ...
        return [
            ...
            'required w/ modSpecRule' => [
                'args'   => [false, $modSpecRule],
                'expect' => [
                    'isOptional' => false,
                    'modSpecRule' => $modSpecRule,
                ]
            ],
            'optional w/ modSpecRule' => [
                'args'   => [true, $modSpecRule],
                'expect' => [
                    'isOptional' => true,
                    'modSpecRule' => $modSpecRule,
                ]
    ...
    {
        $rule = new ChangeModifyRule(...$args);
        $this->assertHasPropertiesSameAs($expect, $rule);
    }

    public function test__construct__withInvalidModSpecRule()
    {
        $this->expectException(\InvalidArgumentException::class);
        $this->expectExceptionMessage(
            'Argument 1 to '.ChangeModifyRule::class.'::setModSpecRule() must satisfy $1->isOptional() === true.'
        );

        new ChangeModifyRule(false, new ModSpecRule(false));
    }
