...
//            'Argument 1 to '.LdifChangeRecordRule::class.'::__construct() must be consistent with argument 2, '.
//            'however the condition $1 === $2->isOptional() is not satisfied.'
//        );
//
//        new LdifChangeRecordRule(false, new ModSpecInitRule(true));
//    }
//
...
//        $this->expectException(\InvalidArgumentException::class);
//        $this->expectExceptionMessage(
//            'Argument 1 to '.LdifChangeRecordRule::class.'::setAttrValSpecRule() must satisfy $1->isOptional() === true.'
//        );
//
//        new LdifChangeRecordRule(false, null, new AttrValSpecRule(false));
//    }
//
//    //
//    // parse()
