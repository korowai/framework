 ...
 * @covers \Korowai\Lib\Ldif\Input
 *
 * @internal
 */
final class InputTest extends TestCase
{
    public function testImplementsInputInterface(): void
    {
    ...
    public function testConstructWithSourceFileName(): void
    {
        $im = $this->createMock(IndexMap::class);
     ...
     */
    public function testGetSourceCharOffset(Input $input, array $cases): void
    {
     ...
     */
    public function testSourceLines(Input $input, array $expLines, array $expLinesMap): void
    {
     ...
     */
    public function testGetSourceLine(Input $input, array $cases): void
    {
     ...
     */
    public function testGetSourceLineIndex(Input $input, array $cases): void
    {
     ...
     */
    public function testGetSourceLineAndOffset(Input $input, array $cases): void
    {
        foreach ($cases as $i => $expect) {
    ...
    public function testGetSourceLineAndOffsetWithEmptyMap(): void
    {
     ...
     */
    public function testGetSourceLineAndCharOffset(Input $input, array $cases): void
    {
        foreach ($cases as $i => $expect) {
            [$expLine, $expOffset] = $expect;
