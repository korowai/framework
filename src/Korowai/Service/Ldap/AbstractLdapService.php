<?php
/**
 * @file src/Korowai/Service/Ldap/AbstractLdapService.php
 *
...
abstract class AbstractLdapService implements LdapServiceInterface
{
     ...
     * @throws \Korowai\Service\Ldap\Exception\LdapServiceException
     */
    public function createSearchQuery(int $id, string $base_dn, string $filter, array $options = array()) : SearchQueryInterface
    {
        return $this->getLdap($id)->createSearchQuery($base_dn, $filter, $options);
    }
}
